...
if __name__ == '__main__':
	#MNIST=sys.argv[1]
	#draw_data=sys.argv[2]
	[C,Lxs,Lzs]=np.load('draw_data.npy')
	...
	for t in range(T):
		...
		if interactive:
			...
			imgname='%s_%d.png' % ('MNIST',t) # you can merge using imagemagick, i.e. convert -delay 10 -loop 0 *.png mnist.gif
			plt.savefig(imgname)
			print(imgname)
	f=plt.figure()
